  ...
  return (
    <div className="row">
        <div className="col-md-12">
            ...
            <div className="col-7 col-sm-9">
                <p className="mb-0"> {formattedAddress}</p>
            </div>
            </div>
            )}
                                    ...
                                    <div className="card-body pt-3">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="ps-3">
                                                ...
                                                {addressText && <p className="mb-1">{addressText}</p>}
                                                ...
                                                {profile?.cover_images?.length > 0 && (
                                                    <div className="d-flex flex-wrap gap-2 mt-2">
                                                        {profile.cover_images.map((img: string, index: number) => (
                                                            <a key={index} href={resolveImageUrl(img)} target="_blank" rel="noreferrer">
                                                                <img
